...
exports.ServiceGroup$inboundSchema = z.object({
    ...
    service_levels: z.array(servicelevelwithparent_js_1.ServiceLevelWithParent$inboundSchema),
}).transform((v) => {
...
exports.ServiceGroup$outboundSchema = z.object({
    ...
    serviceLevels: z.array(servicelevelwithparent_js_1.ServiceLevelWithParent$outboundSchema),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
        flatRate: "flat_rate",
